 ...
 * generated in the com.danjerous.sga.servicio package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListarPersonas_QNAME = new QName("http://servicio.sga.danjerous.com/", "listarPersonas");
    private final static QName _ListarPersonasResponse_QNAME = new QName("http://servicio.sga.danjerous.com/", "listarPersonasResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.danjerous.sga.servicio
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.danjerous.com/", name = "listarPersonas")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.danjerous.com/", name = "listarPersonasResponse")
